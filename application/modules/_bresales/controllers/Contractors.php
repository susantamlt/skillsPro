...
class Contractors extends MX_Controller 
{
	...
	public function contractors_list() {
		...
		foreach($result['aaData'] as $row){
			...
			$row[9] = '<a href="'.base_url('sales/contractors/contractors_view/').$row[0].'" title="View Record" data-toggle="tooltip"><i class="glyphicon glyphicon-eye-open" ></i></a>&nbsp;&nbsp;<a href="'.base_url('sales/contractors/contractors_edit/').$row[0].'" title="View Record" data-toggle="tooltip"><i class="glyphicon glyphicon-edit" ></i></a>';
	...
	public function contractors_edit($id="") {
		$this->load->view('common/sales-top');
		$this->load->view('contractors/contractorsedit');
		$this->load->view('common/sales-bottom');
	}

	public function contractors_view($id="") {
		$this->load->view('common/sales-top');
		$this->load->view('contractors/contractorsview');
		$this->load->view('common/sales-bottom');
	}
}