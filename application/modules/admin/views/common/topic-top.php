                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <ul class="ml-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url('admin/topic');?>" class="">Topic List</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="ml-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url('admin/course');?>" class="">Course List</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li>
                                    <a href="<?php echo base_url('admin/class/addclass');?>" class="">Add Class</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('admin/class');?>" class="">Class List</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="ml-menu">
                                ...
                                <li>
                                    <a href="<?php echo base_url('admin/library');?>" class="">Library List</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
