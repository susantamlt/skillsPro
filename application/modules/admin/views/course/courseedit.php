        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div id="massage"></div>
                <div class="body">
                     <?php echo form_open_multipart('admin/course/course_save', array('id'=>'course_form','name'=>'course_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
                    <div class="form-group">
                      <label class="col-md-2">Course Topic<span class="mandatory" style="color: red">*</span></label>
                      <div class="col-md-4">
                         <?php echo form_dropdown('topic_id',$ljp_topic,$ljp_data[0]['topic_id'],'class="form-control" id="topic_id"') ?>
                      ...
                      <div class="col-md-4">
                          <input type="text" name="course_name" id="course_name" class="form-control" value="<?php echo $ljp_data[0]['course_name']; ?>" placeholder="Course Name" />
                     ...
                     <div class="form-group">
                      ...
                      <div class="col-md-4">
                          <input type="text" name="chapter" id="chapter" class="form-control" value="<?php echo $ljp_data[0]['course_chapter'] ?>" placeholder="Chapter" />
                      ...
                      <div class="col-md-4">
                         <input type="text" name="city" id="city" class=" form-control" value="<?php echo $ljp_data[0]['course_city'] ?>" placeholder="City" />
                    ...
                    <div class="form-group demo-masked-input">
                      ...
                      <div class="col-md-4">
                        <input type="text" name="start_date" id="start_date" class="date form-control" value="<?php echo date('m/d/Y',strtotime($ljp_data[0]['start_date'])); ?>" placeholder="mm/dd/yyyy" />
                      ...
                      <div class="col-md-4">
                        <input type="text" name="end_date" id="end_date" class="date form-control" value="<?php echo date('m/d/Y',strtotime($ljp_data[0]['end_date'])) ;?>" placeholder="mm/dd/yyyy" />
                      ...
                      <div class="col-md-10">
                       <input type="text" name="video_link" id="video_link" class="form-control" value="<?php echo $ljp_data[0]['video_link']?>" placeholder="Link"/>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <textarea name="course_description" id="course_description" class="form-control"><?php echo $ljp_data[0]['course_description']; ?></textarea>
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        <input type="hidden" name="course_id" id="course_id" value="<?php echo $ljp_data[0]['course_id']; ?>">
                        <button type="submit" class="btn btn-success"> Update </button>
                        <a href="<?php echo base_url('admin/course') ?>" type="button" class="btn btn-danger"> Back</a> 
                      </div>
                    </div>
                  <?php echo form_close(); ?>
                </div>
          ...
          submitHandler: function(form,event){
            ...
            $.ajax({
              ...
              success: function(res) {
                ...
                if(resD.status=='1'){
                  var html = '<div class="alert alert-success fade in alert-dismissible" style="margin-top:18px;"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a><strong>Success!Course successfuly Update </strong></div>';
                  $('#massage').html(html);
                  window.setTimeout(function () {
                    location.href = "<?php echo site_url('admin/course/courselist') ?>";
                  }, 2000);
                } else {
