              ...
              <div class="body">
                <?php echo form_open_multipart('admin/module/module_save', array('id' =>'module_form','name'=>'module_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                    <?php echo form_dropdown('course_id',$ljp_course,$ljp_module[0]['course_id'],'class="form-control" id="course_id"') ?>
                    ...
                    <div class="col-md-4">
                    <?php echo form_dropdown('section_id',$ljp_section,$ljp_module[0]['section_id'],'class="form-control" id="section_id"') ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-4">
                      <input type="text" name="module_name" id="module_name" class="form-control" value="<?php echo $ljp_module[0]['module_name']; ?>" placeholder="Module Name" />
                    ...
                    <div class="col-md-4">
                      ...
                      <?php echo form_dropdown('is_active',$ljp_active,$ljp_module[0]['is_active'],'class="form-control" id="is_active"') ?>
                    ...
                    <div class="col-md-4">
                      <?php $ljp_type=array(''=>'--Select One--','V'=>'Video','A'=>'Audio','T'=>'Text/PDF/Word/Excel','W'=>'Website/Blog Link','S'=>'Twitter/Facebook Content'); ?>
                      <?php echo form_dropdown('contect_type',$ljp_type,$ljp_module[0]['content_type'],'class="form-control" id="contect_type"') ?>
                    ...
                    <div class="form-group" id="Dynamic_link_upload">
                      ...
                      <div class="col-md-4" id="labeldiv">
                        <input type="text" name="link_input_value" id="link_input_value" class="form-control" value="<?php echo $ljp_module[0]['content_link']; ?>" placeholder="Link"/>
                      ...
                      <div class="col-md-4" id="filediv">
                        <input type="file" name="file_upload_value" id="file_upload_value" class="form-control" value="<?php echo $ljp_module[0]['content']; ?>" placeholder="Link"/>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <input type="hidden" name="module_id" id="module_id" value="<?php echo $ljp_module[0]['module_id']; ?>">
          ...
          submitHandler: function(form,event){
            ...
            $.ajax({
              ...
              success: function(res) {
                ...
                if(resD.status=='1'){
                  var html = '<div class="alert alert-success fade in alert-dismissible" style="margin-top:18px;"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a><strong>Success!</strong> Module successfully Updatead</div>';
                  $('#massage').html(html);
