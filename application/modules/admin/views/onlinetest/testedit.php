              ...
              <div class="body">
                <?php echo form_open_multipart('admin/test/test_save', array('id' =>'test_form','name'=>'test_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
                  ...
                  <label class="col-md-2">Course Name<span class="mandatory" style="color:red">*</span></label>
                    <div class="col-md-4">
                        <?php echo form_dropdown('course_id',$ljp_course,$ljp_data[0]['course_id'],'class="form-control" id="course_id"') ?>
                    ...
                    <label class="col-md-2">Test Type</label>
                        ...
                        <?php echo form_dropdown('question_type',$question_type,$ljp_data[0]['online_test_type'],'class="form-control" id="question_type"') ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                        <input type="text" name="online_test_name" id="online_test_name" class="form-control" value="<?php echo $ljp_data[0]['online_test_name'] ?>" placeholder="Test Name"/>
                      ...
                      <label class="col-md-2">Status</label>
                        <div class="col-md-4">
                          ...
                          <?php echo form_dropdown('status',$status,$ljp_data[0]['status'],'class="form-control" id="status"'); ?>
                      ...
                      <div class="col-md-4">
                        <input type="time" id="time" name="time" value="<?php echo date('H:i',strtotime($ljp_data[0]['time_duration_hours'])) ;?>" class="form-control" placeholder="hh:ss" />
                      </div>
                     </div>
                    <div class="form-group demo-masked-input">
                       <label class="col-md-2"> Start Date </label>
                        <div class="col-md-4">
                          <input type="text" id="start_date" name="start_date" value="<?php echo date('m/d/Y',strtotime($ljp_data[0]['start_date'])) ;?>" class="date form-control" placeholder="mm/dd/yyyy" />
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <input type="hidden" name="online_test_id" id="online_test_id" value="<?php echo $ljp_data[0]['online_test_id']; ?>">
                      <button type="submit" class="btn btn-success"> Save </button>
                      <a href="<?php echo site_url('admin/test/testlist') ?>" class="btn btn-danger"> Cancel </a>
                    </div>
                  </div>
                <?php echo form_close(); ?>
              </div>
      ...
      $(function() {
        ...
        $("form[name='test_form']").validate({
          ...
          submitHandler: function(form,event){
            ...
            formData.append('online_test_id', $('#online_test_id').val());
            $.ajax({
              url: form.action,
              type: form.method,
              async:false,
              ...
              success: function(res) {
                ...
                if(resD.status=='1'){
                  var html = '<div class="alert alert-success fade in alert-dismissible" style="margin-top:18px;"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a><strong>Success!Test Updated Successfully</strong></div>';
                  $('#massage').html(html);
