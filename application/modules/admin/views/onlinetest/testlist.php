                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">                            
                            <div class="header" style="border-bottom:none;">
                              <h2 class="col-md-6" style="padding:0px;">Test List</h2>
                                ...
                                <table id="dataManual" class="table table-bordered table-striped" style="width:100%;">
                                  <thead>
                                    <tr>
                                      ...
                                      <th title="Test Name"> Test Name </th>
                                      <th title="Test Name"> Course Name </th>
                                      <th title="Test Name"> Duration of Test </th>
                                      <th title="Test Name"> Start Time </th>
...
<script type="text/javascript">
  $(function () {
    $('#dataManual').DataTable({
      "bServerSide": true,
      "sAjaxSource": "<?php echo site_url('admin/test/test_list'); ?>",
      "sServerMethod": "POST",
