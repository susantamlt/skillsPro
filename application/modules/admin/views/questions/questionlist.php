                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">                            
                            <div class="header" style="border-bottom:none;">
                              <h2 class="col-md-6" style="padding:0px;"> List</h2>
                                ...
                                <table id="dataManual" class="table table-bordered table-striped" style="width:100%;">
                                  <thead>
                                    <tr>
                                      ...
                                      <th title="Topic Name">Course Name </th>
                                      <th title="Course Name"> Questions  </th>
                                      <th title="Chapter Name"> Questions Type</th>
...
<script type="text/javascript">
  $(function () {
    $('#dataManual').DataTable({
      "bServerSide": true,
      "sAjaxSource": "<?php echo site_url('admin/questions/question_list'); ?>",
      "sServerMethod": "POST",
