...
class Classes extends MX_Controller 
{
	...
	public function addclass() {
		$this->load->view('common/clients-top');
		$this->load->view('classes/addclass');
		$this->load->view('common/clients-bottom');
	}
	public function class_list() {
        ...
        foreach ($result['aaData'] as $row) {
            ...
            $row[5] = '<a href="'.base_url('clients/classes/class_view/').$row[0].'" title="View Record" data-toggle="tooltip"><i class="glyphicon glyphicon-eye-open" ></i></a>&nbsp;&nbsp;<a href="'.base_url('clients/classes/class_edit/').$row[0].'" title="Assign Sourcing Team" data-toggle="tooltip"><i class="glyphicon glyphicon-edit" ></i></a>';
