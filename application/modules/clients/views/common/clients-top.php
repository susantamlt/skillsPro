            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="user-info">
                    ...
                    <div class="info-container">
                        <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $this->session->userdata('clients_user_name'); ?></div>
                        <div class="email"><?php echo $this->session->userdata('clients_email'); ?></div>
                        <div class="btn-group user-helper-dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li role="seperator" class="divider"></li>
                                <li><a href="<?php echo config_item('base_url');?>login/clients_logout/"><i class="material-icons">input</i>Sign Out</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
