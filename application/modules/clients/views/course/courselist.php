                        ...
                        <div class="card">                            
                            <div class="header" style="border-bottom:none;">
                              ...
                              <div class="col-md-6" style="padding:0px; text-align:right;">
                                <a href="<?php echo site_url('clients/course/addcourse') ?>" data-toggle="tooltip" title="Add New Record" class="btn btn-success btn-background"><i class="glyphicon glyphicon-plus"></i></a>
                                ...
                                <table id="dataManual" class="table table-bordered table-striped" style="width:100%;">
                                  <thead>
                                    <tr>
                                      ...
                                      <th title="Course Topic"> Course Topic </th>
...
<script type="text/javascript">
  $(function () {
    $('#dataManual').DataTable({
      "bServerSide": true,
      "sAjaxSource": "<?php echo site_url('clients/course/course_list'); ?>",
      "sServerMethod": "POST",
