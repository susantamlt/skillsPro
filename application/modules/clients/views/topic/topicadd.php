				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="card">
							...
							<div id="massage"></div>
							<div class="body">
								<?php echo form_open_multipart('clients/topic/topic_save', array('id' =>'topic_form','name'=>'topic_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
									<div class="form-group">
										<label class="col-md-2"> Topic Name<span class="mandatory" style="color:red">*</span> </label>
										<div class="col-md-4">
											<input type="text" name="topic_name" id="topic_name" class="form-control" value="" placeholder="Topic Name" />
											<label id="topic_name-error" class="error" for="topic_name"></label>
										</div>
										<label class="col-md-2">  File Upload </label>
                                        <div class="col-md-4">
                                            <input type="file" name="resume_upload" id="resume_upload" class="form-control" value="" placeholder="" />
									...
									<div class="form-group">
										<div class="col-md-12">
											...
											<a href="<?php echo site_url('clients/topic/') ?>" class="btn btn-danger"> Cancel </a>
										</div>
									</div>
								<?php echo form_close(); ?>
							</div>
                      ...
                      formData.append('file_name', $('#resume_upload')[0].files[0]);
						...
						$.ajax({
							...
							success: function(res) {
								...
								if(resD.status=='1'){
									var html = '<div class="alert alert-success fade in alert-dismissible" style="margin-top:18px;"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a><strong>Success!</strong> Topic successfully Save</div>';
									$('#massage').html(html);
									window.setTimeout(function () {
										location.href = "<?php echo site_url('clients/topic') ?>";
									}, 5000);
								} else { 
