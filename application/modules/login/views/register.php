...
<body class="signup-page">
    <div class="signup-box">
        <div class="logo">
            <a href="javascript:void(0);"><b>Cozmo Yachts</b></a>
            <small>Cozmo Yachts Portal</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_up" method="POST">
                    ...
                    <div class="m-t-25 m-b--5 align-center">
                        <a href="<?php echo config_item('base_url');?>login/">You already have a membership?</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="<?php echo config_item('assets_dir');?>js/pages/examples/sign-up.js"></script>
</body>
