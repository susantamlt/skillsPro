        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <div class="card">
                ...
                <div id="massage"></div>
                <div class="body">
                  <?php echo form_open_multipart('recruiter/interview/schedule_save', array('id'=>'interview_form','name'=>'interview_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-4">
                      <?php $array=array(''=>'--Select One--','1'=>'Shortlisted','2'=>'On-Hold','3'=>'Interview Schedule','4'=>'Rejected');?>
                  ...
                  <label class="col-md-2">Schedule Comments</label>
                    ...
                    <div class="form-group">
                      <div class="col-md-12">
                        ...
                        <a href="<?php echo base_url('recruiter/interview') ?>" type="button" class="btn btn-danger"style="border-radius:5px"> Back</a> 
                      </div>
                    </div>
                  <?php echo form_close(); ?>
                </div>
              ...
              success: function(res) {
                ...
                if(resD.status=='1'){
                  ...
                  window.setTimeout(function () {
                    location.href = "<?php echo site_url('recruiter/interview') ?>";
                  }, 2000);
                } else {
