                        ...
                        <div class="card">  
                            <div class="header" style="border-bottom:none;">
                              ...
                              <div class="col-md-6" style="padding:0px; text-align:right;">
                               <!--  <a href="<?php echo base_url('recruiter/interview/interview_form') ?>" type="button" class="btn btn-primary btn-lg" style="border-radius:6px;"> Schedule Interview</a> -->
...
<script type="text/javascript">
  $(function () {
    $('#dataManual').DataTable({
      "bServerSide": true,
      "sAjaxSource": "<?php echo site_url('recruiter/interview/interview_list'); ?>",
      "sServerMethod": "POST",
