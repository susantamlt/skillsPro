					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="card">
							...
							<div class="body">
								...
								<div class="form-group" style="clear:both;">
									<div class="col-md-12">
										<input type="hidden" name="user_id" id="user_id" value="<?php echo $_SESSION['requirter_user_id']; ?>">
										<input type="hidden" name="org_id" id="org_id" value="<?php echo $_SESSION['requirter_org_id']; ?>">
										...
										<a href="<?php echo site_url('recruiter/requirements/requirements_assign') ?>" class="btn btn-default">Assign</a>
									</div>
								</div>
							</div>
						</div>
