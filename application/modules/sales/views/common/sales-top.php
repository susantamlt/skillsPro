    ...
    <body class="theme-red">
        ...
        <section>
            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="menu">
                    <ul class="list">
                        <li id="dashboard" class="ourmenu active"><a href="<?php echo config_item('base_url');?>sales/"><i class="material-icons">home</i><span>Dashboard</span></a></li>
                        <li id="leads" class="ourmenu"><a href="<?php echo config_item('base_url');?>sales/leads/" class=""><i class="material-icons">view_list</i><span>Leads</span></a></li>
