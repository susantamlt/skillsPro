								...
								<?php echo form_open_multipart('sales/emailmessage/emailmessage_save', array('id' =>'emailmessage_form','name'=>'emailmessage_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
									<div class="form-group">
										...
										<?php $template_type=array(''=>'--Select One--','SMS'=>'SMS','EMAIL'=>'EMAIL','NOTIFICATION'=>'NOTIFICATION') ?>
											<?php echo form_dropdown('template_type',$template_type,'','class="form-control" id="template_type"') ?>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea name="template_title" id="template_title" class="form-control" value="" placeholder="Template Title"></textarea>
											<label id="template_title-error" class="error" for="template_title"></label>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2">Template Content<span class="mandatory" style="color:red">*</span> </label>
										<div class="col-md-10">
											<textarea name="template_content" id="template_content" class="form-control" value="" placeholder="Template Content"></textarea>
