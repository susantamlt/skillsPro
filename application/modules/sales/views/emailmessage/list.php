                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">  
                            <div class="header" style="border-bottom:none;">
                              <h2 class="col-md-6" style="padding:0px;">Template List</h2>
                              <div class="col-md-6" style="padding:0px; text-align:right;">
                                <a href="<?php echo site_url('sales/emailmessage/emailmessage_add') ?>" data-toggle="tooltip" title="Add New Record" class="btn btn-success btn-background"><i class="glyphicon glyphicon-plus"></i></a>
                          ...
                          <div class="header" style="border-bottom:none;">
                              <div class="col-md-2">
                                ...
                                <?php echo form_dropdown('template_type',$template_type,'','class="form-control filterDataNoSuspicious" id="template_type"') ?>
                               </div> 
                            </div>
                            <div class="body">
                                ...
                                <table id="dataManual" class="table table-bordered table-striped" style="width:100%;">
                                  <thead>
                                    <tr>
                                      ...
                                      <th title="Contractors Name"> Template Type </th>
                                      <th title="Status"> Template Title </th>
...
<script type="text/javascript">
  $(function () {
    $('#dataManual').DataTable({
      "bServerSide": true,
      "sAjaxSource": "<?php echo site_url('sales/emailmessage/emailmessage_list'); ?>",
      "sServerMethod": "POST",
      "fnServerParams": function (aoData) {
                aoData.push(
                  { "name": "template_type", "value": $('#template_type').val() }
                );
              },
