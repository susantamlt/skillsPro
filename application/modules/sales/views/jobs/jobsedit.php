						...
						<div class="card">
							...
							<div class="body">
								<?php echo form_open_multipart('sales/jobs/jobs_save', array('id' =>'jobs_form','name'=>'jobs_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
									<fieldset>
										<legend>Job Opening Information </legend>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<?php echo form_dropdown('cat_id',$ljp_catid,$jobs[0]['cat_id'],'class="form-control" id="cat_id"') ?>
											...
											<div class="col-md-4">
												<?php echo form_dropdown('prospect_type_id',$ljp_industry,$jobs[0]['prospect_type_id'],'class="form-control" id="prospect_type_id"') ?>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="work_experience" id="work_experience" class="form-control" value="<?php echo $jobs[0]['work_experience']; ?>" placeholder="Work Experience" />
												<label id="work_experience-error" class="error" for="work_experience"></label>
											</div>
											<label class="col-md-2"> Salary </label>
											<div class="col-md-4">
												<div class="col-md-7" style="padding-left:0px;">
													<input type="text" name="salary" id="salary" class="form-control" value="<?php echo $jobs[0]['salary']; ?>" placeholder="Salary" />
													<label id="salary-error" class="error" for="salary"></label>
												</div>
												<div class="col-md-5" style="padding-left:0px;padding-right:0px;">
													<?php echo form_dropdown('type_salary',$ljp_typeSalary,$jobs[0]['type_salary'],'class="form-control" id="type_salary"') ?>
									...
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<input type="text" name="no_of_prospect" id="no_of_prospect" class="form-control" value="<?php echo $jobs[0]['no_of_prospect']; ?>" placeholder="Number of Positions" />
												<label id="no_of_prospect-error" class="error" for="no_of_prospect"></label>
											</div>
											<label class="col-md-2"> Revenue per Position </label>
											<div class="col-md-4">
												$<input type="text" name="revenue_per_position" id="revenue_per_position" class="form-control" value="<?php echo $jobs[0]['revenue_per_position']; ?>" placeholder="0" style="display:inline-block;width:97%" />
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												$<input type="text" name="missed_revenue" id="missed_revenue" class="form-control" value="<?php echo $jobs[0]['missed_revenue']; ?>" placeholder="0" style="display:inline-block;width:97%" />
									...
									<fieldset>
										...
										<div class="form-group">
											<label class="col-md-12"> Leads Description <span class="mandatory" style="color: red" >*</span></label>
											<div class="col-md-12">
