				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="card">
							...
							<div class="body">
								<?php echo form_open_multipart('sales/leads/leadsearch', array('id' =>'jobs_form','name'=>'jobs_form','class'=>'form-horizontal','enctype'=>'multipart/form-data','method'=>'POST')); ?>
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												<?php echo form_dropdown('lead_type',$ljp_leadcat,'','class="form-control" id="lead_type"') ?>
