    ...
    $.fn.uploadFile = function (options) {
        ...
        function createProgressDiv(obj, s) {
            ...
            this.cancel = $("<div class='ajax-file-upload-red " + s.cancelButtonClass + " " + obj.formGroup + "'>" + s.cancelStr + "</div>").appendTo(this.statusbar)
                .hide();
            this.uploadFile = $("<div class='ajax-file-upload-green'>" + s.uploadStr + "</div>").appendTo(this.statusbar);
            ...
            this.newForm = $("<form></form>").appendTo(this.statusbar).html($("#"+s.extraForm).html());
            if(s.showQueueDiv)
            ...
            var options = {
                ...
                beforeSubmit: function (formData, $form, options) {
                    if(s.onSubmit.call(this, fileArray) != false) {
                        ...
                        var arr =pd.newForm.serializeArray();
                         $.each(arr, function(i, field){
                         	  if(s.fileData != undefined) 
                         	   	options.formData.append(field.name, field.value);
                             else 
