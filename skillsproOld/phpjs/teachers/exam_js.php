	...
	$("#btn_submit").click(function(e){
		...
		if(valid==1){
			$.ajax({
				...
				data:{"online_test_name":online_test_name,"topic_id":topic_id,"course_id":course_id,"online_test_level":online_test_level,"online_test_type":online_test_type,"start_date":start_date,"end_date":end_date,"number_of_questions":number_of_questions,"time_duration_minutes":time_duration_minutes,"time_duration_hours":time_duration_hours,"online_test_id":online_test_id},
				dataType:"json",
				success:function(data){
					if(data.result==1){
						$("#error").hide();
