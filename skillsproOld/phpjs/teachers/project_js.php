	...
	$("#btn_submit").click(function(e){
		...
		if(valid==1){
			$.ajax({
				...
				data:{'partner_id':partner_id,'project_id':project_id,'type':type,"project_name":project_name,"topic_id":topic_id,"course_id":course_id,'project_description':project_description,'project_files':project_files,'project_video_link':project_video_link,'is_video':is_video,'created_by':'P','teacher_id':teacher_id,'is_teacher':is_teacher,'project_id':project_id,'mode':mode},
				dataType:"json",
				success:function(data){
					if(data.result==1){
						$("#error").hide();
